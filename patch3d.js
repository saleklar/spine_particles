...
const code1 = code.replace(t1, r1);
const code2 = code1.replace(t2, r2);
fs.writeFileSync('src/Scene3D.tsx', code2);
if (code !== code2) console.log('Successfully patched Scene3D.tsx');
