...
const tStart = code.indexOf('export const vertexShader');
const tEnd = code.indexOf('export type FireGeneratorProps');
...
const correct = \xport const vertexShader = \\\
varying vec2 vUv;
void main() {
    vUv = uv;
...
code = code.substring(0, tStart) + correct + code.substring(tEnd);
