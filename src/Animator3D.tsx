        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '12px' }}>
            ...
            <div>
              ...
              {project.object.geometry === 'cylinder' && (
                <div style={{ marginBottom: '16px', padding: '12px', backgroundColor: '#252525', borderRadius: '4px' }}>
                  ...
                  <div style={{ marginTop: '12px' }}>
                    ...
                    <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                      Ridge Depth: {ridgeDepth.toFixed(2)}
                    </label>
                    <input
                      type="range"
                      min="0.1"
                  ...
                  <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid #333' }}>
                    ...
                    {bevelEnabled && (
                      <>
                        <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                          Bevel Width: {(bevelWidth * 100).toFixed(0)}%
                        </label>
                        <input
                          type="range"
                          min="0.02"
              ...
              {(project.object.geometry === 'cylinder' || project.object.geometry === 'coin') && (
                <div style={{ marginTop: '16px', padding: '12px', backgroundColor: '#252525', borderRadius: '4px' }}>
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Side Ridge Count: {project.object.material.sideRidgeCount}
                  </label>
                  <input
                    type="range"
                    min="30"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Side Ridge Depth: {project.object.material.sideRidgeDepth.toFixed(2)}
                  </label>
                  <input
                    type="range"
                    min="0.1"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Side Bump Scale: {project.object.material.sideBumpScale.toFixed(2)}
                  </label>
                  <input
                    type="range"
                    min="0"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Side U Scale: {project.object.material.sideUvScaleX.toFixed(2)}
                  </label>
                  <input
                    type="range"
                    min="0.1"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Side V Scale: {project.object.material.sideUvScaleY.toFixed(2)}
                  </label>
                  <input
                    type="range"
                    min="0.1"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Side UV Rotation: {project.object.material.sideUvRotation.toFixed(0)}°
                  </label>
                  <input
                    type="range"
                    min="-180"
              ...
              <div style={{ marginTop: '16px', padding: '12px', backgroundColor: '#252525', borderRadius: '4px' }}>
                ...
                <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                  U Scale: {project.object.material.uvScaleX.toFixed(2)}
                </label>
                <input
                  type="range"
                  min="0.1"
                ...
                <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                  V Scale: {project.object.material.uvScaleY.toFixed(2)}
                </label>
                <input
                  type="range"
                  min="0.1"
                ...
                <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                  U Offset: {project.object.material.uvOffsetX.toFixed(2)}
                </label>
                <input
                  type="range"
                  min="-1"
                ...
                <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                  V Offset: {project.object.material.uvOffsetY.toFixed(2)}
                </label>
                <input
                  type="range"
                  min="-1"
                ...
                <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                  UV Rotation: {project.object.material.uvRotation.toFixed(0)}°
                </label>
                <input
                  type="range"
                  min="-180"
              ...
              <label style={{ display: 'block', marginTop: '16px', marginBottom: '4px', fontSize: '12px' }}>
                Metalness: {project.object.material.metalness.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '12px' }}>
                Roughness: {project.object.material.roughness.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
          ...
          {activePanel === 'effects' && (
            <div>
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Intensity: {project.effects.bloom.intensity.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Threshold: {project.effects.bloom.threshold.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Radius: {project.effects.bloom.radius.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Amount: {project.effects.lens.amount.toFixed(4)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Count: {Math.round(project.effects.sparkles.count)}
              </label>
              <input
                type="range"
                min="10"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Size: {project.effects.sparkles.size.toFixed(1)}
              </label>
              <input
                type="range"
                min="0.5"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Intensity: {project.effects.sparkles.intensity.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Speed: {project.effects.sparkles.speed.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Glint Threshold: {project.effects.sparkles.glintThreshold.toFixed(2)}
              </label>
              <input
                type="range"
                min="0.3"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Glint Spread: {project.effects.sparkles.glintSpread.toFixed(2)}
              </label>
              <input
                type="range"
                min="0.2"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Center Threshold: {project.effects.sparkles.glintCenterThreshold.toFixed(2)}
              </label>
              <input
                type="range"
                min="0.2"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Ray Length: {project.effects.sparkles.glintRayLength.toFixed(2)}
              </label>
              <input
                type="range"
                min="0.5"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Ray Boost: {project.effects.sparkles.glintRayBoost.toFixed(2)}
              </label>
              <input
                type="range"
                min="0.5"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Horizontal Blur: {project.effects.sparkles.glintHorizontalBlur.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Vertical Blur: {project.effects.sparkles.glintVerticalBlur.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Glow Blur: {project.effects.sparkles.glowBlur.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
          ...
          {activePanel === 'lighting' && (
            <div>
              ...
              <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                Intensity: {project.lighting.ambientIntensity.toFixed(2)}
              </label>
              <input
                type="range"
                min="0"
              ...
              {project.lighting.directionalLights.length > 0 && (
                <>
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>
                    Intensity: {project.lighting.directionalLights[0].intensity.toFixed(2)}
                  </label>
                  <input
                    type="range"
                    min="0"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>Position X: {project.lighting.directionalLights[0].position.x.toFixed(0)}</label>
                  <input
                    type="range"
                    min="-500"
                    max="500"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>Position Y: {project.lighting.directionalLights[0].position.y.toFixed(0)}</label>
                  <input
                    type="range"
                    min="-500"
                    max="500"
                  ...
                  <label style={{ display: 'block', marginBottom: '4px', fontSize: '11px' }}>Position Z: {project.lighting.directionalLights[0].position.z.toFixed(0)}</label>
                  <input
                    type="range"
                    min="-500"
                    max="500"
