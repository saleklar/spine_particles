...
const regex = /const boneAnim = \{ translate: \[\] as any\[\], scale: \[\] as any\[\] \};[\s\S]*?spineData\.animations\.animation\.bones\[boneName\] = boneAnim;/;
...
console.log('Fixed export loop and rotation!');
